...
export const fullStackProgram = {
  ...
  hero: {
    ...
    subtitle:
      'Learn frontend and backend with MongoDB, Express, React, and Node. Build real world projects and a capstone for your portfolio, and graduate job ready with the skills hiring teams expect.',
    images: [
      '/hero/fsd-hero-1.png',
      '/hero/fsd-hero-2.png',
      '/hero/fsd-hero-3.png',
  ...
  why: {
    ...
    lead: 'A career focused full stack program built to take you from learning to interview ready.',
    cards: [
      {
  ...
  fee: {
    ...
    imageAlt: 'Full stack developer working on a laptop in a modern coworking space',
    name: 'Macro Program',
    price: '₹25,000',
      ...
      overview: [
        {
          ...
          a: 'No prior experience is necessary. Our curriculum is designed to take you from beginner to job ready full stack developer.',
        },
        {
