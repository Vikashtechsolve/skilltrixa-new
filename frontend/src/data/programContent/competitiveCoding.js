...
export const competitiveCodingProgram = {
  ...
  tech: {
    eyebrow: 'Core Topics',
    title: "Data Structures & Algorithms You'll Master",
    lead: 'A comprehensive curriculum covering every DSA topic tested in coding interviews at top product companies.',
    cards: [
      { icon: 'code', heading: 'Data Structures', tags: ['Arrays', 'Trees', 'Graphs', 'Heaps'] },
      { icon: 'server', heading: 'Algorithms', tags: ['Sorting', 'Searching', 'Greedy', 'Backtracking'] },
      { icon: 'database', heading: 'Dynamic Programming', tags: ['Memoization', 'Tabulation', 'DP on Trees', 'Bitmask DP'] },
      { icon: 'gitbranch', heading: 'Advanced Topics', tags: ['Segment Trees', 'Tries', 'Disjoint Sets', 'Graph Algorithms'] },
    ],
  },
  ...
  admission: {
    ...
    titleTail: 'Process',
    deck: 'A clear, three-step path: validate your coding baseline, choose your track with a mentor, then start solving with structure and support.',
  ...
  fee: {
    ...
    imageAlt: 'Competitive coder working in a modern coding environment',
    name: 'Macro Program',
    price: '₹25,000',
  ...
  testimonialsHeader: {
    ...
    lead: 'See how Skilltrixa learners cracked coding interviews and landed SDE roles at top companies.',
  },
  testimonials: [
    {
      id: 'arjun',
      ...
      role: 'SDE-1',
      company: 'Amazon',
      photo: '/testimonials/Arjun_reddy.jpg',
    ...
    },
    {
      ...
      company: 'Google',
      photo: '/testimonials/Ankit_yadav.jpg',
      program: 'Competitive Coding Macro',
      duration: '5 months',
      salaryHike: 'First job',
      quote: 'Weekly contests and live coding sessions gave me the speed and confidence I needed. I cleared all 5 rounds at Google.',
    },
    {
      id: 'vikram',
      name: 'Vikram Singh',
      role: 'SDE-2',
      company: 'Microsoft',
      photo: '/testimonials/Vikram_singh.jpg',
      program: 'Competitive Coding Macro',
      duration: '4 months',
      salaryHike: '+85%',
      quote: 'The DP and Graph modules were exceptional. My Codeforces rating jumped 400 points in just 3 months of structured practice.',
    },
  ],
  ...
  faq: {
    ...
    data: {
      overview: [
        { q: 'Do I need prior coding experience?', a: 'Basic programming knowledge in any language (C++, Java, or Python) is recommended. We start from DSA fundamentals and build up.' },
        ...
        { q: 'Which programming language should I use?', a: 'We primarily teach in C++ and Python, but you can use any language you are comfortable with for solving problems.' },
      ],
      macro: [
