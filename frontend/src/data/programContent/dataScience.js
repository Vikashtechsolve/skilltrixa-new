...
export const dataScienceProgram = {
  meta: {
    ...
    description:
      'Learn Data Science with Skilltrixa. Python, Pandas, NumPy, statistics, and ML basics with real world projects and placement support.',
  },
  ...
  hero: {
    ...
    subtitle:
      'Learn Python, data analysis, and machine learning with Pandas, NumPy, and Matplotlib. Build a dashboard, a prediction model, and a business insights project, and graduate ready to turn data into clear decisions.',
    images: [
      '/hero/fsd-hero-1.png',
      '/hero/fsd-hero-2.png',
      '/hero/fsd-hero-3.png',
  ...
  why: {
    ...
    lead: 'A career focused data science program built to take you from learning to interview ready.',
    cards: [
      {
  ...
  fee: {
    ...
    imageAlt: 'Data professional working on a laptop in a modern coworking space',
    name: 'Macro Program',
    price: '₹25,000',
  ...
  testimonials: [
    {
      ...
      role: 'Data Analyst',
      company: 'Razorpay',
      photo: '/testimonials/Aakash_kumar.jpg',
      program: 'Data Science Macro Program',
      duration: '3 months',
      salaryHike: '+58%',
      quote:
    ...
    },
    {
      ...
      company: 'Swiggy',
      photo: '/testimonials/Sahil_mehta.jpg',
    ...
    },
    {
      ...
      company: 'Deloitte',
      photo: '/testimonials/Neha_singh.jpg',
